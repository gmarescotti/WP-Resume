...
function store_experience_in_post( $section, $org_name, $org_location, $org_link, $from, $to, $title, $details) {
   ...
   if (!$org_term) {
      $org_term = store_new_organization($org_name, $org_location, $org_link);
   }
...
function store_new_organization($org, $location, $website) {
   global $_REQUEST;
   $_REQUEST = array(
	'org_link' => $website,

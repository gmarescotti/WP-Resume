...
<li id="contact_info_row[]" class="contact_info_row">
	<select name="wp_resume_linkedin[contact_info_field][]" id="contact_info_field[]">
	<option></option>
	...
	<input type="text" name="wp_resume_linkedin[contact_info_value][]" id="contact_info_value[]" value="<?php echo $value; ?>"/> <br />
</li>
